...
import concurrency.base.util.AppWrapper;
 ...
 */
public class LogCountRunner {

    public static void main(String[] args) throws Exception {
        AppWrapper.invokeMain0(LogCountRunner.class, args, false);
    }
    ...
    private static InputStream createInputStream() {
        ...
        InputStream dataIn = LogCountRunner.class
        ...
        SequenceInputStream si = new SequenceInputStream(
                new Enumeration<InputStream>() {
                    ...
                    public InputStream nextElement() {
                        ...
                        if (null != fileName) {
                            try {
                                in = LogCountRunner.class.getResourceAsStream("/data/ch4case02/"
                                        + fileName);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
